                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildMasterCard(
                           context,
                           "Екатерина Курчавина",
                           "Регрессолог, игропрактик",
                           "КАГОМЭ-КАГОМЭ (Трансформация)",
                           "«КАГОМЭ-КАГОМЭ» — Специальный сет игры «Территория Себя».\n\nЕкатерина — уникальный специалист, объединяющий точность и творчество. Преподаватель ментальной арифметики и английского языка, педагог и сертифицированный диагност по методу «Индивидуальная Диагностика Потенциала». Её называют «психологом с душой».\n\nВ то время как автор игры Олег Баранец дает structure и стратегию, Екатерина предлагает альтернативное прочтение методики — творческое и игривое.\n\nЧто вас ждет за столом Екатерины:\n🎲 Глубокая работа в легком формате: работа с 22 ролями-архетипами через призму творчества.\n🎲 Расширение границ: переключение между логикой и интуицией.\n🎲 Безопасное пространство: для тех, кто хочет исследовать свои стратегии без давления.\n\nКому подойдет: Тем, кто хочет проработать серьезный запрос, но устал от «сложных щей» и жестких рамок.",
